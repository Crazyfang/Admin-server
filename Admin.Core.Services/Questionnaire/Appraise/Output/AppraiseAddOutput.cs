...
namespace Admin.Core.Service.Questionnaire.Appraise.Output
{
    public class AppraiseAddOutput
    {
        /// <summary>
        /// 主键
        /// </summary>
        ...
        public IList<HouseHoldMemberAddOutput> Members { get; set; }
        ...
        /// 平房数量
        /// </summary>
        public int BungalowCount { get; set; } = 1;
        ...
        /// 别墅数量
        /// </summary>
        public int CottageCount { get; set; } = 1;
        ...
        /// 商品房数量
        /// </summary>
        public int GoodsBuildingCount { get; set; } = 1;
        ...
        /// 汽车持有数量
        /// </summary>
        public int CarHoldCount { get; set; } = 1;
